...
* <img src="../img/logoYolo.jpg" width="200" style="border-radius: 10px;" /> **Ultralytics YOLOv8**: Utilizado para treinamento de IA e conexão ao banco de dados, permitindo o reconhecimento eficiente de padrões e análise de dados em tempo real.
